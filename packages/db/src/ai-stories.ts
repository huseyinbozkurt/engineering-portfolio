...
function toProjectInput(
  ...
  const url = nullableTextField(part, "url");
  const githubUrl = nullableTextField(part, "githubUrl");
  ...
  return createProjectSchema.parse({
    ...
    url,
    githubUrl,
    releaseStatus: url ? "released" : "in-development",
    sourceAvailability: githubUrl ? "open-source" : "closed-source",
    seoTitle: nullableTextField(part, "seoTitle"),
    seoDescription: nullableTextField(part, "seoDescription"),
    ogImage: nullableTextField(part, "ogImage"),

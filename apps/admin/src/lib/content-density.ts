 ...
 *
 * Kept in sync with apps/public-site/src/lib/content-density.ts.
 */
 ...
 */
export const PREVIEW_SECTION_MAX_H = "max-h-32"; // ~8rem — a single structured section (Strengths, Issues…)

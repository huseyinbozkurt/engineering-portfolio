...
export function DeleteForm({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="rounded-lg border border-rose-400/40 bg-rose-500/10 px-4 py-2 text-sm font-semibold text-rose-200 transition hover:border-rose-300/60 hover:bg-rose-500/20"
      >
        {label}
      </button>
    </ConfirmedForm>
